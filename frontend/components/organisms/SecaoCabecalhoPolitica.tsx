...
export default function SecaoCabecalhoPolitica() {
      ...
      <div className="max-w-4xl mx-auto space-y-6 relative z-10">
        ...
        <div className="space-y-2 pt-6">
          ...
          <p className="text-muted-foreground text-sm sm:text-base max-w-2xl">
            Esta política de privacidade descreve como a plataforma Minha UEM acessa, utiliza, protege e armazena os seus dados provenientes dos serviços da sua Conta do Google.
          </p>
